<div class="diary-item diary-item--inline">
    ...
    <div class="diary-item__image">
        <a href="<?php echo '/blog/' . generateSlug($article['perex_title']) . "/${article['id']}/"; ?>"><img
                src="<?php echo $article['image_url']; ?>" alt="<?php echo $article['perex_title']; ?>"></a>
    </div>
